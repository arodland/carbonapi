...
func (e expr) GetName() string {
	return fmt.Sprintf("%s(%s)", e.target, e.argString)
}

func makeMetricData(e *expr, a *metricData) metricData {
	r := *a
	r.Name = proto.String(e.GetName())
